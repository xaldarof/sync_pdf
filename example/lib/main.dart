...
class _CreatePdfState extends State<CreatePdfStatefulWidget> {
  ...
  PdfLayoutResult drawHeader(PdfPage page, Size pageSize, PdfGrid grid) {
    ...
    page.graphics.drawString(
        r'$' + getTotalAmount(grid).toString(), PdfStandardFont(PdfFontFamily.helvetica, 18),
  ...
  void addProducts(String productId, String productName, double price, int quantity, double total,
      PdfGrid grid) {
